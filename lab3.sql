...
("He's into Her","Zhu Yi","Romance"),
("The Kings Fantasy","Jane Austin","Romance"),
("Marry My Husband","Suzanne Collins","Dystopian Fiction");
...
ALTER TABLE borrow ADD COLUMN borrow_return_date TIMESTAMP NULL DEFAULT NULL;